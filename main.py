...
class Calculator(Frame):
    ...
    def create_widgets(self):
        ...
        self.button_7.grid(row=1, column=0, sticky="nesw")
        ...
        self.button_8.grid(row=1, column=1, sticky="nesw")
        ...
        self.button_9.grid(row=1, column=2, sticky="nesw")
        ...
        self.button_C = Button(self, text="C", command=self.backspace)
        ...
        self.button_4.grid(row=2, column=0, sticky="nesw")
        ...
        self.button_5.grid(row=2, column=1, sticky="nesw")
        ...
        self.button_6.grid(row=2, column=2, sticky="nesw")
        ...
        self.button_2.grid(row=3, column=1, sticky="nesw")
        ...
        self.button_3.grid(row=3, column=2, sticky="nesw")
        ...
        self.button_lpar = Button(self, text="(", command= lambda: self.add_historic("("))
        self.button_lpar.grid(row=3, column=4, sticky="nesw")
        self.master.bind("(", lambda event: self.add_historic("("))


        self.button_0 = Button(self, text="0", command= lambda: self.add_historic("0"))
        self.button_0.grid(row=4, column=0, sticky="nesw")
        ...
        self.button_eq.grid(row=4, column=2, sticky="nesw")
        ...
        self.button_rpar = Button(self, text=")", command= lambda: self.add_historic(")"))
        self.button_rpar.grid(row=4, column=4, sticky="nesw")
        self.master.bind(")", lambda event: self.add_historic(")"))
